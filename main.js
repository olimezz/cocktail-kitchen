  ...
  const drinksData = [
    {
      ...
      items: [
        ...
        { name: "Hugo Spritz", desc: "Liqueur St-Germain • Menta • Lime • Soda", price: "€8" },
        { name: "Lucky Limoncello Spritz", desc: "Limoncello • Midori • Soda • Lime", price: "€8" },
        { name: "Negroni Classico", desc: "Gin • Campari • Vermouth Rosso", price: "€8" },
        { name: "Ratafia Negroni", desc: "Gin • Campari • Ratafia", price: "€8" },
        { name: "Manhattan", desc: "Rye Whiskey • Vermouth Rosso • Angostura", price: "€8" },
        { name: "Old Fashioned", desc: "Bourbon Whiskey • Angostura • Orange", price: "€8" },
        { name: "Chartreuse Daiquiri o Classico", desc: "Gold Rum • Lime • Cointreau Syrup • Maraschino • Chartreuse", price: "€8" },
        { name: "Pornstar Martini", desc: "Vodka • Passion Fruit • Vanilla • Lime • Prosecco", price: "€8" },
        { name: "Cosmopolitan", desc: "Vodka • Cointreau • Succo di mirtillo • Lime", price: "€8" },
        { name: "Vanilla Espresso Martini", desc: "Vanilla Vodka • Espresso • Kahlua", price: "€8" },
        { name: "Amaretto Sour", desc: "Amaretto • Lemon • Egg White • Angostura", price: "€8" },
        { name: "Midori Sour", desc: "Midori • Lemon • Egg White • Soda", price: "€8" },
        { name: "Paloma", desc: "Tequila • Pompelmo • Lime • Soda • Sale • Cointreau", price: "€8" },
        { name: "Moscow Mule", desc: "Vodka • Ginger Beer • Lime", price: "€8" },
        { name: "Rum Punch", desc: "Rum • Orange • Lime • Grenadine • Angostura • Noce Moscata", price: "€8" },
        { name: "Dirty Martini", desc: "Vodka • Dry Vermouth • Brine", price: "€8" },
        { name: "Skinny Margarita", desc: "Tequila • Lime • Triple Sec • Sale", price: "€8" },
        { name: "Dark and stormy", desc: "Dark Rum • Ginger Beer • Lime", price: "€8" }
      ]
    },
    {
      section: "Analcolici - Zero Proof",
      items: [
        { name: "Elderflower Mojito", desc: "Fiori di sambuco • Lime • Menta • Soda", price: "€8" },
        { name: "Virgin Mary", desc: "Succo di pomodoro • Lime • Sale • Tabasco • Worcestershire Sauce", price: "€8" },
        { name: "Tropicana", desc: "Mango • Cocco • Frutto Passione • Ananas • Lime", price: "€8" },
        { name: "Nogroni", desc: "Gin analcolico • Vermouth rosso • San Bitter", price: "€8" }
      ]
    },
    {
      section: "Wines",
      subsections: [
        {
          title: "House Wine - Mezzo Litro",
          items: [
            { name: "House White | House Rosé", desc: "", price: "€10" }
          ]
        },
        {
          title: "Bianchi",
          items: [
            { name: "Pecorino", desc: "Azienda Agricola Chiusa Grande", price: "€4 | €20" },
            { name: "Cococciola Vinosophia", desc: "Azienda Agricola Chiusa Grande", price: "€24" },
            { name: "Pinot Bianco Hofstätter", desc: "Azienda J. Hofstätter", price: "€32" },
            { name: "Gewürztraminer Elena Walch", desc: "Azienda Elena Walch", price: "€45" }
          ]
        },
        {
          title: "Rosati",
          items: [
            { name: "Cerasuolo d'Abruzzo", desc: "Azienda Agricola Chiusa Grande", price: "€4 | €20" },
            { name: "Rosato Calafuria", desc: "Azienda Antinori", price: "€26" },
            { name: "Cerasuolo DNA d'Eusanio", desc: "Azienda Agricola Chiusa Grande", price: "€30" },
            { name: "Rosato Bolgheri", desc: "Azienda Antinori", price: "€35" }
          ]
        },
        {
          title: "Rossi",
          items: [
            { name: "Montepulciano d'Abruzzo", desc: "Azienda Agricola Chiusa Grande", price: "€4 | €20" },
            { name: "Abracadabra Maiolica", desc: "Azienda Agricola Chiusa Grande", price: "€24" },
            { name: "Nebbiolo (Langhe)", desc: "Azienda Ochetti", price: "€43" },
            { name: "Brunello di Montalcino DOCG", desc: "Azienda Belfoggio", price: "€80" }
          ]
        }
      ]
    },
    {
      section: "Bollicine",
      items: [
        { name: "Bellussi Blanc de Noir Mignon", desc: "", price: "€16" },
        { name: "Bellussi Blanc de Blancs", desc: "", price: "€6 | €30" },
        { name: "Prosecco Bellussi Rosé", desc: "", price: "€30" },
        { name: "Franciacorta Muratori Brut", desc: "", price: "€40" },
        { name: "Franciacorta Muratori Rosé", desc: "", price: "€45" },
        { name: "Franciacorta Muratori Satèn Rosé", desc: "", price: "€50" },
        { name: "Trento DOC Marchesi (Pas Dosé)", desc: "", price: "€60" },
        { name: "Aubry Brut Premier Cru", desc: "", price: "€90" },
        { name: "Ruinart Rosé", desc: "", price: "€150" }
      ]
    },
    {
      section: "Happy Hour",
      items: [
        { name: "Aperitivo cenato di terra", desc: "Incluso un drink", price: "€16" },
        { name: "Aperitivo cenato di mare", desc: "Incluso un drink", price: "€22" }
      ]
    }
  ];

  const drinksMenuContainer = document.getElementById('dynamic-drinks-menu');
  if (drinksMenuContainer) {
    let html = '';
    drinksData.forEach(section => {
      html += `<div class="menu-section"><h3>${section.section}</h3>`;
      ...
      if (section.subsections) {
        section.subsections.forEach(sub => {
          html += `<div class="menu-subsection"><h4>${sub.title}</h4>`;
    ...
    drinksMenuContainer.innerHTML = html;
  }
